...
---------------------------------*/
$query1="select choix from choix";
$resultat1=mysqli_query($db,$query1);
$donnee1=mysqli_fetch_array($resultat1);

//Si subway 
if ($donnee1['choix']=='subway') {
